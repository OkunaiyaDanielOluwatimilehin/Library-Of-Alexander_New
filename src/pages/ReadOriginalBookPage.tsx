    ...
    return (
      ...
      >
        ...
        <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-12 pb-16 sm:pb-24">
          ...
          <div 
            className="prose prose-neutral sm:prose-xl max-w-4xl mx-auto text-[#2D2D2D] font-[Open_Sans] text-base sm:text-lg md:text-xl leading-[1.9] sm:leading-[35.2px] prose-p:mb-7 sm:prose-p:mb-8 prose-p:mt-4 sm:prose-p:mt-8 prose-p:leading-[1.9] sm:prose-p:leading-[35.2px]
              prose-p:first-of-type:first-letter:float-left prose-p:first-of-type:first-letter:text-5xl sm:prose-p:first-of-type:first-letter:text-7xl md:prose-p:first-of-type:first-letter:text-8xl prose-p:first-of-type:first-letter:font-black prose-p:first-of-type:first-letter:pr-3 sm:prose-p:first-of-type:first-letter:pr-4 prose-p:first-of-type:first-letter:pt-1 sm:prose-p:first-of-type:first-letter:pt-2 prose-p:first-of-type:first-letter:font-display select-none
            "
            style={{
              WebkitUserSelect: 'none',
              MozUserSelect: 'none',
